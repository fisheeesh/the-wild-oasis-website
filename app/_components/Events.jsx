    ...
    return (
        <section className='py-20 flex flex-col gap-8'>
            ...
            <div className='grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-7'>
                {
                    events.map(event => (
                        <div key={event.name} className='flex flex-col space-y-4'>
                            ...
                            <div onClick={handleClick} className='uppercase text-lg border-b cursor-pointer border-b-primary-800 w-fit'>See Detail</div>
                        </div>
                    ))
                }
            </div>
